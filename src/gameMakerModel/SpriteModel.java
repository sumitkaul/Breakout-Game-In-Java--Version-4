...
public class SpriteModel implements GameObjectModel {
	...
	private String spriteName,spriteImage;
	...
	public SpriteModel(String spriteName,String spriteImage,int posX, int posY, int speedX, int speedY, int width, int height, List<String> behaviourList,boolean updateX, boolean updateY){
		this.posX = posX;
		this.posY = posY;
		this.speedX = speedX;
		this.speedY = speedY;
